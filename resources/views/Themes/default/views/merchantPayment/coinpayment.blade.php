                        ...
                        <div class="shadow bg-white py-4">
                            <form action="{{ url('payment/coinpayments/make-transaction') }}" method="POST">
                                ...
                                <div class="d-flex justify-content-between border-top">
                                    <div class="px-4 py-2">
                                        <p class="font-weight-600"> Total Amount ({{$currencyCode}})</p>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between border-top">
                                    <div class="px-4 py-2">
                                        <p class="font-weight-600">Payment method</p>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between border-top">
                                    <div class="px-4 py-2">
                                        <p class="font-weight-600">Total amount <span id="selected-iso"></span></p>
                                    </div>
                                ...
                                <div class="mt-4 px-4">
                                    <button class="btn btn-primary px-4 py-2 w-100">Pay Now</button>
                                </div>

                                <div class="mt-4">
                                    <p class="text-center font-weight-600 text-gray-500">Cancel your payment | Transaction history</p>
                                </div>
