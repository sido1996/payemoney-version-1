				...
				<div class="row mt-4 justify-content-center">
					<div class="col-md-12 col-lg-8  px-0 shadow bg-white py-4">
						<div class="row px-4 py-2">
							<div class="col-md-5">
								<p class="text-lg-right"> Status :</p>
							</div>
						...
						<div class="row px-4 py-2">
							<div class="col-md-5">
								<p class="text-lg-right"> Total amount to send :</p>
							</div>

							<div class="col-md-7">
								<p>{{ $transactionInfo['result']['amountf'] . ' ' . $transactionInfo['result']['coin'] }} (Total confirms need: {{ $transactionDetails['result']['confirms_needed'] }})</p>
							</div>
						</div>
						<hr class="mt-2 mb-0">
						...
						<div class="row px-4 py-2">
							<div class="col-md-5">
								<p class="text-lg-right"> Receive so far :</p>
							</div>
						...
						<div class="row px-4 py-2">
							<div class="col-md-5">
								<p class="text-lg-right"> Balance Remaining:</p>
							</div>
						...
						<div class="row px-4 py-2">
							<div class="col-md-5">
								<p class="text-lg-right"> Send To Address:</p>
							</div>
						...
						<div class="row px-4 py-2">
							<div class="col-md-5">
								<p class="text-lg-right"> Time Left For Us to Confirm Funds:</p>
							</div>
						...
						<div class="row px-4 py-2">
							<div class="col-md-5">
								<p class="text-lg-right"> Payment ID:</p>
							</div>
						...
						<hr class="mt-2 mb-0">
						<p class="text-center"> <a href="{{ $transactionDetails['result']['status_url'] }}" target="_blank">Alternative Link</a> | <a href="{{ url('transactions') }}">Transaction Histories</a></p>
					</div>
				</div>
